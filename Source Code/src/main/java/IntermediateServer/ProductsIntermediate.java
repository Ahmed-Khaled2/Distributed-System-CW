...
public class ProductsIntermediate {
    ...
    public ProductsIntermediate(String ProductName, String ProductDescription, String ProductPrice, int ProductStockLevel, String ProductImage) {
